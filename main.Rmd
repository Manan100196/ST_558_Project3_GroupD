...
A bar plot of number of shares vs Days of the week is generated. The conclusion is that the number of shares are high during weekdays specially on Monday and Wednesday. The shares decreases during the weekend.
```{r plot2}
