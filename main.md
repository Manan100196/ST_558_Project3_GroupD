...
```
    ...
    ## # … with 6,846 more rows, 44 more variables: average_token_length <dbl>,
    ## #   num_keywords <dbl>, kw_min_min <dbl>, kw_max_min <dbl>, kw_avg_min <dbl>,
    ...
    ## #   weekday_is_monday <dbl>, weekday_is_tuesday <dbl>,
    ## #   weekday_is_wednesday <dbl>, weekday_is_thursday <dbl>, …
...
<img src="main_files/figure-gfm/plot1-1.png" style="display: block; margin: auto;" />
...
specially on Mopnday and Wednesday. The shares decsreases during the
weekend.
...
<img src="main_files/figure-gfm/plot2-1.png" style="display: block; margin: auto;" />
...
<img src="main_files/figure-gfm/plot3-1.png" style="display: block; margin: auto;" />
...
<img src="main_files/figure-gfm/plot4-1.png" style="display: block; margin: auto;" />
...
<img src="main_files/figure-gfm/plot5-1.png" style="display: block; margin: auto;" />
...
<img src="main_files/figure-gfm/plot5-2.png" style="display: block; margin: auto;" />
...
<img src="main_files/figure-gfm/plot6-1.png" style="display: block; margin: auto;" />
<!---------------------------------------------------------------------------->
...
<img src="main_files/figure-gfm/plot_after_var_selection-1.png" style="display: block; margin: auto;" />
...
<img src="main_files/figure-gfm/pca-1.png" style="display: block; margin: auto;" />
...
```
    ...
    ##         model_method model_rmse
    ## 1  Forward Selection   8066.717
    ## 2 Backward Selection   8069.407
    ## 3      Random Forest   8144.069
    ## 4       Boosted Tree   7948.822
